...
/// @nodoc
class __$$ObserveImplCopyWithImpl<$Res>
...
class _$ObserveImpl implements _Observe {
  const _$ObserveImpl();
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$ObserveImpl);
  }
...
abstract class _Observe implements NetworkEvent {
  const factory _Observe() = _$ObserveImpl;
}
...
class _$NotifyImpl implements _Notify {
  const _$NotifyImpl(this.isConnected);
...
abstract class _Notify implements NetworkEvent {
  const factory _Notify(final bool isConnected) = _$NotifyImpl;
